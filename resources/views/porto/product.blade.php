    ...
    <div class="container">
        ...
        <div class="product-single-container product-single-default">
            ...
            <div class="row">
                <div class="col-lg-5 col-md-6 product-single-gallery">
                    <div class="product-slider-container">
                        ...
                        <div class="label-group">
                            ...
                            <div class="product-label label-sale">-{{ $products_discount->discount }}%</div>
                        </div>
                        @endif
                        <div class="product-single-carousel owl-carousel owl-theme show-nav-hover">
                            @foreach ($gallery as $gallery)
                            <div class="product-item">
                                <img class="product-single-image" src='{{ asset("storage/$gallery") }}' data-zoom-image="{{asset('storage/$gallery')}}" width="468" height="468" alt="product" />
                            </div>
                            @endforeach
                        </div>
                        ...
                        <div class="prod-thumbnail owl-dots">
                            ...
                            <div class="owl-dot">
                                <img src='{{ asset("storage/$thumbnail") }}' width="110" height="110" alt="product-thumbnail" style="min-height: 110px; min-width: 110px;max-height: 110px; max-width: 110px; object-fit:cover" />
                            </div>
                            @endforeach
                        </div>
                ...
                <div class="col-lg-7 col-md-6 product-single-details">
                    <h1 class="product-title d-none">{{$product->name}}</h1>
                                ...
                                <span class="product-popup">
                                    <span class="box-content">
                                        <img alt="product" width="150" height="150"
                                            src="{{asset('porto/assets/images/products/product-3.jpg')}}"
                        ...
                        <div class="product-next">
                            <a href="#">
                                ...
                                <span class="product-popup">
                                    <span class="box-content">
                                        <img alt="product" width="150" height="150"
                                            src="{{asset('porto/assets/images/products/product-4.jpg')}}"
                                            style="padding-top: 0px;">
                    ...
                    <div class="price-box d-none">
                        ...
                        <span class="product-price" id="product-price"> ${{number_format($product->price ,0)}}</span>
                    </div>
                    ...
                    <div class="product-filters-container">
                        ...
                        <div class="product-single-filter d-none">
                            ...
                            <ul class="config-size-list">
                                @foreach ($product->skuCodes as $skuCode)
                                <li class="" onclick="showVariationPrice({{ $skuCode->price }})">
                                    <a href="javascript:;" class="d-flex align-items-center justify-content-center" style="height: 50px;">
                                        @foreach ($skuCode->attribute_list as $attribute)
                                        {{ $attribute['value'] }} <br>
                                        @endforeach
                                    </a>
                                </li>
                        ...
                        <div class="product-single-filter">
                             <livewire:SkuCProductVariations :productId="$product->id"/>
                        </div>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="product-size-content" role="tabpanel" aria-labelledby="product-tab-size">
                    <div class="product-size-content">
                        <div class="row">
                            <div class="col-md-4">
                                <img src="{{asset('porto/assets/images/products/single/body-shape.png')}}" alt="body shape" width="217" height="398">
                            </div>
                            <!-- End .col-md-4 -->
                        ...
                        <div class="comment-list">
                            <div class="comments">
                                <figure class="img-thumbnail">
                                    <img src="{{asset('porto/assets/images/blog/author.jpg')}}" alt="author" width="80" height="80">
                                </figure>
        ...
        <div class="products-section pt-0">
            ...
            <div class="products-slider owl-carousel owl-theme dots-top dots-small">
                @foreach ($products_in_same_category as $product )

                <div class="product-default">
                    <figure>
                        <a href="/product/{{ $product->id }}">
                            <img src='{{ asset("storage/$product->image") }}' width="280" height="280" alt="product" style="min-height: 280px; min-width: 280px;max-height: 280px; max-width: 280px; object-fit:cover">
                            @php
                            $gallery = $product->gallery;
                            @endphp
                            <img src='{{ asset("storage/$gallery[0]") }}' width="280" height="280" alt="product" style="min-height: 280px; min-width: 280px;max-height: 280px; max-width: 280px; object-fit:cover">
                        </a>
            ...
            <div class="col-lg-3 col-sm-6 pb-5 pb-md-0 appear-animate" data-animation-name="fadeInLeftShorter"
                ...
                <div class="product-default left-details product-widget">
                    ...
                    <div class="product-details">
                        ...
                        <div class="price-box">
                            <span id="product-price" class="product-price">${{ number_format($product->price, 0) }}</span>
                        </div>
                        <div class="price-box">
