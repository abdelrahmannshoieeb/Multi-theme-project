                    ...
                    <ul class="contact-info">
                        <li>
                            ...
                            <span id="branch-address">
                                <?php if(Session::has('branch')): ?>
                                    <?php echo e(Session::get('branch')->address); ?>
                        ...
                        <li>
                            ...
                            <a href="tel:" id="branch-phone">
                                <?php if(Session::has('branch')): ?>
                                    <?php echo e(Session::get('branch')->phone); ?>
...
<!-- End .footer --><?php /**PATH C:\laragon\www\e-connerce-final - Copy\resources\views/porto/layout/footer.blade.php ENDPATH**/ ?>